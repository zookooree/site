<!-- Back page copy, v3: the loom, the lineage, tamazukuri. Source of truth
for dist/story/index.html; every paragraph must render verbatim (enforced by
scripts/check-copy.mjs). No em or en dashes. Issue #8. -->
