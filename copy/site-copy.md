...
The repos are open at [github.com/zookooree](https://github.com/zookooree). Read a retro. Read a soul document — then write one for the agent you were about to duct-tape together, and notice what changes. If you find a broken thread, pull it. The line is built to stop.
